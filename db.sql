...
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('juan1@.com', 'juan4@.com', 1, '1juan1@.comjuan4@.com', true, false);
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('juan1@.com', 'juan5@.com', 1, '1juan1@.comjuan5@.com', true, false);
--Invitación a un David
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('juan1@.com', 'david2@.com', 1, '1juan1@.comdavid2@.com', true, false);

INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('david1@.com', 'david4@.com', 2, '2david1@.comdavid4@.com', true, false);
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('david1@.com', 'david5@.com', 2, '2david1@.comdavid5@.com', true, false);
--Invitación a un Juan's
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('david1@.com', 'juan2@.com', 2, '2david1@.comdjuan2@.com', true, false);
INSERT INTO INVITACION(a_email_remitente, a_email_destinatario, c_id_problematica, a_id, b_vigente, b_para_interventor)
    VALUES('david1@.com', 'juan4@.com', 1, '1david1@.comjuan4@.com', true, false);
